...
const NavBar = () => {
   ...
   return (
      <nav>
         <div className="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8 bg-white">
            <div className="flex items-center justify-between h-18 lg:gap-4">
               ...
               <div className="bg-white nav-list absolute  min-h-[16vh] left-0 -top-full w-full flex flex-col gap-6 items-center px-5 py-4 md:w-auto md:min-h-fit md:static md:justify-center lg:gap-12 md:flex-row duration-300">
